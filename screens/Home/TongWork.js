...
class TongWork extends Component{
  ...
  componentDidMount() {
    ...
    const dateKor = "20"+nowDate[2]+"년 "+nowDate[0]+"월 "+nowDate[1]+"일";
    this.setState({dataKor:dateKor})
  }

  imgupload(action, workdate, previmg, imageSource) {
